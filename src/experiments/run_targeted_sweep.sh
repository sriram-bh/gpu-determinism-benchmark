#!/bin/bash
# Run targeted mitigations under MPS with clocks locked.
# Usage: sudo bash src/experiments/run_targeted_sweep.sh
...
echo "=== Targeted Mitigation Sweep ==="
...
python3 -u src/experiments/run_targeted_mitigations.py 2>&1
" | tee $RESULTS/targeted_output.txt
